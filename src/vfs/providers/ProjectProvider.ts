...
export function chrisProject_populate(
    ...
    const pluginInfoPath: string = `${projectPath}/chris_plugin_info.json`;
    vfs.file_create(pluginInfoPath, JSON.stringify({
        title: projectName,
        version: '1.0.0',
        category: 'Medical Imaging',
        description: 'ChRIS plugin scaffold generated by ARGUS'
    }, null, 2));
}
