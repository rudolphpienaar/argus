...
| [x] Done
| Full rewrite. Tree, content, CWD, path resolution (~, .., relative), lazy content generation, events via EventBus. Includes `legacyNode_normalize()` bridge for Phase 4 migration.
