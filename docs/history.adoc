...
conscience (DAG Engine), and a Merkle provenance chain, the late v10 line reached
technical maturity. The `v11.0.0` release marks the transition from hardening era to
contract era: workflow topology, startup protocol, and provenance path semantics are
now treated as stable major-version commitments rather than migration targets. The
next arc is no longer architectural rescue; it is disciplined extension on top of a
declared baseline.

---
_Last updated: 2026-02-23 (v11.0.0)_
