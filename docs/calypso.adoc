...
export type CalypsoAction =
    ...
    | { type: 'stage_advance'; stage: string }
...
A command-line client connects to either the headless server or the browser's WebSocket bridge.
