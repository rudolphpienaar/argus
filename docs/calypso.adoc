...
----
┌─────────┐    ┌─────────────┐    ┌──────────────┐    ┌──────────────┐
│ Surface │───▶│ Fast-Path   │───▶│ IntentParser │───▶│ Workflow     │
└─────────┘    │ (/ + shell) │    └──────────────┘    │ Gatekeeping  │
               └─────────────┘                         └──────┬───────┘
                                                               │
                                                               ▼
