...
While ARGUS provides the graphical framework (the body), CALYPSO provides the logic and natural language understanding (the mind). Born from the infrastructure, she is responsible for:
